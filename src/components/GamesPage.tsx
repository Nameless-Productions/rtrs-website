export default function GamesPage() {
  return (<>
    ...
    <div className="text-center border-2 border-gray-800 w-50 p-3 rounded-xl">
        ...
        <p className="text-gray-400">A 2D survival game where you play as an unemployed young adult. You start with nothing, but you work your way up through technology without ever getting a job.</p>
    </div>
